// game is in debug mode with collision circles displayed
...
window.addEventListener("load", function () {
  ...
  class Player {
    ...
    update() {
      ...
      // check for collisions between players & obstacles
  ...
  class Egg {
    constructor(game) {
      ...
      this.spriteY;
      this.hatchTimer = 0;
      this.hatchInterval = 5000; // 10,000
  ...
  // eggs have hidden timer that hatches each egg into larva, larva will try to hide in forest, player tries to protect by pushing into safety zone or pushing enemies away
  class Larva {
  ...
  class Game {
    ...
    render(context, deltaTime) {
      ...
      // delta time contains the number of milliseconds that happened between this animation frame and the previous
    ...
    init() {
      for (let i = 0; i < 3; i++) {
        this.addEnemy(); // number of enemies
      }
      //obstacles do not touch or overlap, circle packing
      let attempts = 0;
